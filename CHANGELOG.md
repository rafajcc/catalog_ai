...
- **Admin home redirection to the loaded products view.** Once PrestaShop and an AI provider are configured, `/auth/me` reports `ai_configured` and the admin lands directly on the loaded products grid instead of the configuration screen.
