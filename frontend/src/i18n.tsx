...
export const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'upload.prestashopIntro':
      'Descarga productos directamente desde tu tienda PrestaShop (Webservice). Sin EAN ni referencia se importan los primeros productos de la tienda.',
    'upload.prestashopEansLabel': 'Códigos EAN (opcional, uno por línea o separados por comas)',
    'upload.prestashopEansPlaceholder': '8412345678901, 8423456789012',
  ...
  en: {
    ...
    'upload.prestashopIntro':
      'Fetch products directly from your PrestaShop store (Webservice). Without EANs or references, the first products of the store are imported.',
    'upload.prestashopEansLabel': 'EAN codes (optional, one per line or comma-separated)',
    'upload.prestashopEansPlaceholder': '8412345678901, 8423456789012',
